...
export default function HomeFaqSection() {
  ...
  return (
    <section id="faq" className="faq-page faq-page--home" aria-labelledby="home-faq-heading">
      <header className="faq-page__header">
        <div className="faq-page__title-row">
          ...
          <h2 id="home-faq-heading" className="faq-page__title">
            {t("faq.title")}
          </h2>
        </div>
          ...
          return (
            <section key={section.id} id={section.id} className="faq-page__section" aria-labelledby={`faq-h-${section.id}`}>
              <div className="faq-page__section-head">
                ...
                <h3 id={`faq-h-${section.id}`} className="faq-page__section-title">
                  {section.title}
                </h3>
              </div>
